...
public class PedidoDetalles {
    ...
    private List<PedidoDetallesMateriales> materiales;
    ...
    public List<PedidoDetallesMateriales> getMateriales() {
        return this.materiales;
    }

    public void setMateriales(List<PedidoDetallesMateriales> materiales) {
